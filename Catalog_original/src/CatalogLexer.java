...
public class CatalogLexer extends antlr.CharScanner implements CatalogLexerTokenTypes, TokenStream
 {
public CatalogLexer(InputStream in) {
	this(new ByteBuffer(in));
}
public CatalogLexer(Reader in) {
	this(new CharBuffer(in));
}
public CatalogLexer(InputBuffer ib) {
	this(new LexerSharedInputState(ib));
}
public CatalogLexer(LexerSharedInputState state) {
	super(state);
	caseSensitiveLiterals = true;
	setCaseSensitive(true);
	literals = new Hashtable();
	literals.put(new ANTLRHashString("if", this), new Integer(35));
	literals.put(new ANTLRHashString("inside", this), new Integer(43));
	literals.put(new ANTLRHashString("del", this), new Integer(38));
	literals.put(new ANTLRHashString("sortby", this), new Integer(44));
	literals.put(new ANTLRHashString("mv", this), new Integer(37));
	literals.put(new ANTLRHashString("in", this), new Integer(42));
	literals.put(new ANTLRHashString("cp", this), new Integer(36));
	literals.put(new ANTLRHashString("print", this), new Integer(34));
	literals.put(new ANTLRHashString("foreach", this), new Integer(41));
}
...
tryAgain:
	...
	public final void mGREATEQ(boolean _createToken) throws RecognitionException, CharStreamException, TokenStreamException {
		int _ttype; Token _token=null; int _begin=text.length();
		_ttype = GREATEQ;
		int _saveIndex;
	...
	public final void mCOMMENTS(boolean _createToken) throws RecognitionException, CharStreamException, TokenStreamException {
		int _ttype; Token _token=null; int _begin=text.length();
		_ttype = COMMENTS;
		int _saveIndex;
